...
\begin{frame}[allowframebreaks]{Partial Implementation}
    \begin{figure}
		{\includegraphics[scale=.11]{ss1.jpeg} \includegraphics[scale=.11]{ss2.jpeg}
...
\begin{frame}[t]{References}
    \begin{center}
        \begin{itemize}
            ...
            \item Azham Hussain,Mobile Video Streaming Applications: A Systematic Review of Test Metrics in Usability Evaluation,Journal of Telecommunication, Electronic and Computer Engineering.
